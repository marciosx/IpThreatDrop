...
curl https://raw.githubusercontent.com/marciosx/spamhaus_drop/main/stats.json

📊 Estatísticas Atuais
Métrica	Valor
Última atualização	https://img.shields.io/github/last-commit/marciosx/spamhaus_drop
IPs únicos	https://img.shields.io/badge/dynamic/json?color=orange&label=&query=ips_unicos&url=https%253A%252F%252Fraw.githubusercontent.com%252Fmarciosx%252Fspamhaus_drop%252Fmain%252Fstats.json
Sub-redes /24 agregadas	https://img.shields.io/badge/dynamic/json?color=purple&label=&query=subredes&url=https%253A%252F%252Fraw.githubusercontent.com%252Fmarciosx%252Fspamhaus_drop%252Fmain%252Fstats.json
Tamanho	https://img.shields.io/badge/dynamic/json?color=blue&label=&query=tamanho_kb&url=https%253A%252F%252Fraw.githubusercontent.com%252Fmarciosx%252Fspamhaus_drop%252Fmain%252Fstats.json&suffix=KB
...
🔄 Frequência de Atualização
    ...
    Manual: Execute /root/scripts/update_spamhaus.sh no servidor
...
✨ Características do Script
    ...
    ☁️ Upload automático para WebDAV do CasaOS
...
📋 Requisitos do Script
    ...
    Acesso à internet para baixar as listas

    CasaOS com WebDAV ativo na porta 5005

    API Key do OTX AlienVault (obter em otx.alienvault.com)
